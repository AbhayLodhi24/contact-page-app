...
const Dashboard = () => {
  ...
  const [chartData, setChartData] = useState({});
   ...
   // Fetch countries data from API and update state
  useEffect(() => {
    axios(
    ...
    // Fetch historical chart data from API and update state
  useEffect(() => {
    axios.get(
...
// Register Chart.js components
  ...
  return (
    <div className="  w-full pt-20 px-4 pb-8" >
      ...
      {/* Render chart or loading message */}
        {
          chartData.datasets ?
      ...
      >
        ...
        >
           {/* Render map with tile layer and WorldMap component */}
          <TileLayer
